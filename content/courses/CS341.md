...
Observe that $G$ has a cycle if and only if there is a back edge in the DFS forest. We can test this in $O(|V| + |E|)$.

<center>
<img src="/cs341-dfs-forest.png" width="500" height="200" alt="DFS Forest">
</center>

Lastly, it will be worth investigating this expansion of the `explore()` subroutine to create $start$ and $finish$ arrays as such:
