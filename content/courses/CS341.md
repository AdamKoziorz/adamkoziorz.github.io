...
#### Alternatives to Master Theorem (Consider Expanding this for Midterm)
...
So, finding the medians of the medians and partitioning $A$ is $T\left(\frac{n}{5}\right) + O(n)$, and recursing on the appropriate side of $A$ will be $T\left(\frac{7n}{10}\right)$. Our final runtime for calculating the median then satisfies the relation:
