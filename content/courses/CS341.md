...
<center>
<img src="/cs341-bfs.png" width="280" height="200" alt="OS Schematic">
</center>
...
### Time Complexity
Note that each vertex is enqueued, dequeued, and read at most once. Therefore, will do a maximum of $n$ passes for the while loop. Then, using the convention that $d_v$ is the number of neighbours of $v$, we can apply the handshaking lemma to find the for loop is:
